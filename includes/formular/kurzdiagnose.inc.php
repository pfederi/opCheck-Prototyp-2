<div class="row">
	<div class="large-12 columns">
		<form  data-abide="ajax" id="kurzdiag" accept-charset="utf-8">
	    	<div class="row">
			...
			<div class="row">
				<div class="large-12 columns">
					...
					<input type="radio" name="spezialist" value="Ja" id="op-ja" required>
					<label for="op-ja">Ja</label>
					<input type="radio" name="spezialist" value="Nein" id="op-nein" required>
					<label for="op-nein">Nein</label>
				</div>
        	</div>
        	<div class="row">
				<div class="large-12 columns">
					<label for="fo-arzt" class="labelTitle">Wie heisst der Arzt der Ihnen den ersten Befund ausgestellt hat? <small>(Pflichtfeld)</small></label>
					...
					<div class="row">
						<div class="large-8 columns end">
							<input type="text" id="fo-arzt" placeholder="..." required />
						</div>
					</div>
				</div>
        	</div>
