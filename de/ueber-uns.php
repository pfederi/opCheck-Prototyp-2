...
<section class="row">
	<div class="large-12 columns large-centered">
		...
		<div class="row">
			<div class="large-12 columns large-centered">
				<h2>Idee und Förderung durch Adjumed Services AG</h2>
		...
		<div class="row">
			<div class="large-12 columns large-centered">
				<h2>Das opCheck-Team</h2>
				<h4>Patrick Federi</h4>
				<p>Requirements-Engineering & Interaction Design im Rahmen der Masterarbeit HCID 2014.</p>
				<h4>Darko Jergovic</h4>
				<p>Requirements-Engineering & Interaction Design im Rahmen der Masterarbeit HCID 2014.</p>
				<h4>Kate Rageth</h4>
				<p>Requirements-Engineering & Interaction Design im Rahmen der Masterarbeit HCID 2014.</p>
				<h4>Dr. Luzi Rageth</h4>
				<p>Business-Idee und Auftraggeber</p>
			</div>
		</div>
	</div>
</section>
